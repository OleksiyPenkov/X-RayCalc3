...
| 16 | Add tests for `unit_ProfileCalc` — Erf, GetLayerVal, BuildLayers, CalcDensityProfile — 18 tests. Extracted pure math from `unit_ProfilesManager` into new `math/unit_ProfileCalc.pas` (zero VCL deps) | 🟡 M | ✅ Done |
